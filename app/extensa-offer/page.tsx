...
import { ArrowRight, CheckCircle, Users, Clock, Zap, AlertTriangle, Brain, Star } from 'lucide-react';
import StructuredData from './components/StructuredData';
import type { Metadata } from 'next';

export const metadata: Metadata = {
  title: 'AI App Crisis Management - Save Your Failing Project | Extensa',
  description: 'Emergency protocols to rescue failing AI-generated apps. Professional crisis management system that turns disasters into demo-ready successes. Get help now.',
  keywords: 'AI app broken, AI app not working, AI app rescue, failing AI project, AI app debugging, emergency AI app help',
  openGraph: {
    title: 'AI App Crisis Management - Save Your Failing Project',
    description: 'Emergency protocols to rescue failing AI-generated apps. Turn your catastrophe into a success story.',
    url: 'https://extensa.dev/extensa-offer',
    type: 'website',
    images: [{
      url: '/extensa-logo.png',
      width: 1200,
      height: 630,
      alt: 'Extensa AI App Crisis Management'
    }]
  },
  twitter: {
    card: 'summary_large_image',
    title: 'AI App Crisis Management - Save Your Failing Project',
    description: 'Emergency protocols to rescue failing AI-generated apps.',
    images: ['/extensa-logo.png']
  }
};

export default function CrisisManagementLanding() {
  return (
    <>
      <StructuredData />
